/* logicaland2.c   source
 *
 * Description:
 * logicalor is a command line program which takes two arguments, both rep-
 * resenting binary numbers which will be bitewise logical ed and output as
 ...
 * bitwise  of the original arrays.
 *
...
int main(int argc, char *argv[]) {
    ...
    if(argc != 3){
        printf("usage: logicaland arg1 arg2\n");
        exit(errorCode);
    }


    if(inputValid(argv[1], argv[2]))
        printAND(argv[1], argv[2]);
    else
